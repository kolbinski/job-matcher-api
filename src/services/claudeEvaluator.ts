      ...
      evaluations: {
        ...
        items: {
          ...
          properties: {
            ...
            matched_reasons: {
              type: 'object',
              description: 'CRITICAL: Only reference information explicitly present in the offer data provided to you. Do NOT infer, estimate, assume, or fabricate any details not present in the offer. If information is not in the offer, do not mention it. CRITICAL: Do NOT mention salary in pros or cons under ANY circumstances — not salary amounts, not salary comparisons, not "salary not disclosed", not currency conversions. Salary is displayed separately in the UI.',
              properties: {
